/* Problem 7.2 | Enhanced-Randomized-Quick-Sort */
...
int main(int argc, char* argv[])
{
	...
	EnhancedRandomizedQuickSort(a1, FIRSTITEMOFARRAY, size, 1);
#if DEBUG
	putchar('\n');
#endif // DEBUG
	EnhancedRandomizedQuickSort(a2, FIRSTITEMOFARRAY, size, 0);
	printf("\nNondecreasing order:\n");
